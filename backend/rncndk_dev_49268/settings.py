"""
Django settings for rncndk_dev_49268 project.
...
ROOT_URLCONF = 'rncndk_dev_49268.urls'
...
WSGI_APPLICATION = 'rncndk_dev_49268.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rncndk_dev_49268 API",
    "DESCRIPTION": "API documentation for rncndk_dev_49268 App",
    "VERSION": "v1",
}
